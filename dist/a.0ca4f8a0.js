...
})({"bwWL2":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ab35057d0ca4f8a0";
"use strict";
...
},{}],"4NxvW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onStartLoadPage", ()=>onStartLoadPage);
parcelHelpers.export(exports, "onAfterLoadPage", ()=>onAfterLoadPage);
parcelHelpers.export(exports, "onLoadPageError", ()=>onLoadPageError);
var _extention = require("../js/common/extention");
var _storageClient = require("./common/storageClient");
// console.log('app11.js'.getLast(1));
(0, _storageClient.storageClient).set("111", {
    a: 1,
    d: 2
});
console.log((0, _storageClient.storageClient).get("111"));
const onStartLoadPage = ()=>{
    console.log("onStartLoadPage");
};
const onAfterLoadPage = ()=>{
    console.log("onAfterLoadPage");
};
const onLoadPageError = (error)=>{
    console.log(error);
};

},{"../js/common/extention":"hdSPj","./common/storageClient":"9Qbka","@parcel/transformer-js/src/esmodule-helpers.js":"j7FRh"}],"hdSPj":[function(require,module,exports) {
//
//
// Vinh
//
...
String.prototype.getFirst = function getFirst(numberCharWantToGet) {
    if (!this) return "";
    if (this.length < numberCharWantToGet) numberCharWantToGet = this.length;
...
Array.prototype.getSubArray = function(fromIndex, toIndex) {
    ...
    let result = [];
    for(let index = fromIndex; index <= toIndex; index++)result.push(this[index]);
    return result;
};
...
},{}],"9Qbka":[function(require,module,exports) {
//
//
// Vinh
//
...
},{}]},["bwWL2","4NxvW"], "4NxvW", "parcelRequirea605")
